...
def attack(char_name: str, char_class: str) -> str:
    """
    Вывести сообщение о результате действия attack.
    char_name -- str
    char_class -- str
    """
...
def defence(char_name: str, char_class: str) -> str:
    """
    Вывести сообщение о результате действия defence.
    char_name -- str
    char_class -- str
    """
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """
    Вывести сообщение о результате действия special.
    char_name -- str
    char_class -- str
    """
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """
    Предложить одну из комманд: attack, defence, special, skip.
    Вывести соответсвующее сообщение. Skip закрывает программу.
    char_name -- str
    char_class -- str
    """
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """
    Спросить название класса персонажа и вывести сообщение.
    Вернуть строку введённую пользователем.
    """
